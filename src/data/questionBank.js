...
// ============================
import { lookupOptionTranslation } from './optionTranslations'
...
export function getLocalizedOption(opt, lang = 'en') {
  ...
  const translated = lookupOptionTranslation(opt.label, lang)
  if (translated && translated !== opt.label) return translated
  return opt.label
}
